...
description = """
dummy_fastapi API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://dummy_fastapi.com/terms/",
    contact={
        "name": "mcmasty",
        "url": "http://dummy_fastapi.com/contact/",
        "email": "mcmasty@dummy_fastapi.com",
    },
    license_info={
        "name": "The Unlicense",
