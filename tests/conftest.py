...
# WARNING: Ensure imports from `dummy_fastapi` comes after this line
from dummy_fastapi import app, settings, db  # noqa
from dummy_fastapi.cli import create_user, cli  # noqa
